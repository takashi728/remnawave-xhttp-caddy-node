...
- node domain
- optional additional inbound TCP ports or ranges
- XHTTP path, auto-generated by default
- Remnawave node secret key

On Debian/Ubuntu, the installer prepares the latest available distro kernel before node setup. Debian uses the matching backports repository when available; Ubuntu uses the matching HWE/generic kernel package. It does not reboot automatically. To skip this step:
